...
*/
func Middleware(config Config) HandlerFunc {
...
func handlePreflight(context *Context, config Config, requestMethod string) bool {
...
func handleRequest(context *Context, config Config) bool {
